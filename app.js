...
function Btn({ children, onClick, primary, wide, small, style }) {
  return /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick,
...
function NutrientBars({ totals, target, slots }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, fontSize: 13, color: C.textMuted, flexWrap: "wrap" } }, slots.map((s, i) => /* @__PURE__ */ React.createElement("span", { key: s.id }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 7, height: 7, borderRadius: "50%", background: colorForIndex(i), marginRight: 3 } }), s.id))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(5, minmax(0,1fr))", gap: 10 } }, metrics.map((m) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { key: m.key, style: { display: "flex", flexDirection: "column", gap: 5 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 17 } }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 500 } }, m.label), /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 500, color: over ? C.danger : under ? C.warnText : C.text } }, Math.round(sum * 10) / 10, "/", tgt)), /* @__PURE__ */ React.createElement(
      "div",
      {
        style: {
          position: "relative",
...
function FoodResultRow({ f, onPick, active }) {
  return /* @__PURE__ */ React.createElement(
    "div",
    {
      onClick: () => onPick(f),
...
function FoodAdder({ foods, categoryOrder, onAddFood, onAddUnconfirmed }) {
  ...
  const handleKeyDown = (e) => {
    ...
    if (e.key === "Tab") {
      e.preventDefault();
      setActiveIndex((i) => e.shiftKey ? (i - 1 + results.length) % results.length : (i + 1) % results.length);
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { position: "relative" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6 } }, /* @__PURE__ */ React.createElement(
    "input",
    {
      ...
      placeholder: "\u98DF\u54C1\u540D\u3092\u5165\u529B\u2026",
      style: { flex: 1, fontSize: 15, padding: "6px 8px", border: `0.5px solid ${C.border}`, borderRadius: 8 }
    }
...
function SlotCard({ slot, index, foods, categoryOrder, onCopy, onPaste, onRemoveSlot, onAddFood, onAddUnconfirmed, onRemoveItem, onEditNutrients }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { background: C.surface, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "1rem 1.1rem" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 600, fontSize: 17, display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 9, height: 9, borderRadius: "50%", background: colorForIndex(index) } }), slot.id), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6 } }, /* @__PURE__ */ React.createElement(IconBtn, { label: "\u3053\u306E\u67A0\u3092\u30B3\u30D4\u30FC", onClick: onCopy }, "\u29C9"), /* @__PURE__ */ React.createElement(IconBtn, { label: "\u8CBC\u308A\u4ED8\u3051", onClick: onPaste }, "\u{1F4CB}"), /* @__PURE__ */ React.createElement(IconBtn, { label: "\u3053\u306E\u67A0\u3092\u524A\u9664", danger: true, onClick: onRemoveSlot }, "\u2715"))), slot.items.length > 0 && /* @__PURE__ */ React.createElement("table", { style: { width: "100%", fontSize: 14.5, borderCollapse: "collapse", marginBottom: 8 } }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", { style: { color: C.textMuted } }, /* @__PURE__ */ React.createElement("td", null, "\u98DF\u54C1\u540D"), /* @__PURE__ */ React.createElement("td", { style: { textAlign: "right" } }, "kcal"), /* @__PURE__ */ React.createElement("td", { style: { textAlign: "right" } }, "P"), /* @__PURE__ */ React.createElement("td", { style: { textAlign: "right" } }, "\u8102"), /* @__PURE__ */ React.createElement("td", { style: { textAlign: "right" } }, "\u70AD"), /* @__PURE__ */ React.createElement("td", { style: { textAlign: "right" } }, "\u5869"), /* @__PURE__ */ React.createElement("td", null))), /* @__PURE__ */ React.createElement("tbody", null, slot.items.map((it) => /* @__PURE__ */ React.createElement("tr", { key: it.id, id: `unconfirmed-item-${it.id}` }, /* @__PURE__ */ React.createElement("td", { style: { padding: "3px 0" } }, it.name, !it.confirmed && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    ...
    "button",
    {
      ...
      "aria-label": "\u524A\u9664",
      style: { border: "none", background: "none", color: C.textMuted, cursor: "pointer", fontSize: 14 }
    },
    "\u2715"
...
function FoodEditModal({ food, allTags, categoryOrder, onSave, onClose, onAddCategory }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(
      ...
      errorMsg && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14.5, color: C.danger, marginBottom: 8 } }, errorMsg),
...
const PAGE_SIZE = 100;
function FoodsTab({ foods, categoryOrder, onAdd, onUpdate, onDelete, onImportMany, onAddCategory, editRequest }) {
  const [q, setQ] = useState("");
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { background: C.surface, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "1rem 1.1rem" } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, marginBottom: 10 } }, "\u65B0\u3057\u3044\u98DF\u54C1\u3092\u767B\u9332"), /* @__PURE__ */ React.createElement(FoodFormFields, { form, setForm, allTags, categoryOrder, newTagText, setNewTagText, onAddCategory }), errorMsg && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14.5, color: C.danger, marginBottom: 8 } }, errorMsg), /* @__PURE__ */ React.createElement(Btn, { primary: true, onClick: submit }, "\u767B\u9332\u3059\u308B")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, /* @__PURE__ */ React.createElement(
    "input",
    {
      placeholder: "\u98DF\u54C1\u540D\u3067\u691C\u7D22",
      value: q,
...
const inputStyle = { fontSize: 15, padding: "7px 9px", border: `0.5px solid ${C.border}`, borderRadius: 8 };
...
function SettingsTab({ target, onSave, categoryOrder, foods, onSaveCategoryOrder }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { background: C.surface, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "1.2rem", maxWidth: 420 } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, marginBottom: 4 } }, "1\u65E5\u306E\u76EE\u6A19\u6442\u53D6\u91CF"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: C.textMuted, marginBottom: 12 } }, "\u76EE\u6A19\u5024\u4EE5\u4E0A\u30FB\u4E0A\u9650\u5024\u4EE5\u5185\u306E\u6442\u53D6\u91CF\u3092\u76EE\u6307\u3057\u307E\u3059\u3002\u3069\u3061\u3089\u304B\u4E00\u65B9\u3060\u3051\u306E\u8A2D\u5B9A\u3082\u53EF\u80FD\u3067\u3059\u3002"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 12 } }, [
    ...
    var _a, _b, _c, _d;
    return /* @__PURE__ */ React.createElement("div", { key: f.k, style: { display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 15, gap: 8 } }, /* @__PURE__ */ React.createElement("span", null, f.label), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, color: C.textMuted } }, "\u76EE\u6A19"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
    ...
    ), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, color: C.textMuted } }, "\u4E0A\u9650"), /* @__PURE__ */ React.createElement(
      "input",
      {
        type: "number",
...
function ImportTab({ onImport, onExportAll, onImportAll, onCopied }) {
  ...
  const doCopyBackup = () => {
    ...
    onCopied == null ? void 0 : onCopied("\u30D0\u30C3\u30AF\u30A2\u30C3\u30D7\u30C7\u30FC\u30BF\u3092\u30B3\u30D4\u30FC\u3057\u307E\u3057\u305F");
  };
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 12, maxWidth: 640 } }, /* @__PURE__ */ React.createElement("div", { style: { background: C.surface, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "1rem 1.1rem" } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, marginBottom: 8 } }, "\u5168\u30C7\u30FC\u30BF\u306E\u30D0\u30C3\u30AF\u30A2\u30C3\u30D7\u30FB\u5225\u306E\u30C1\u30E3\u30C3\u30C8\u3078\u306E\u5F15\u304D\u7D99\u304E"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14.5, color: C.textMuted, lineHeight: 1.6, marginBottom: 10 } }, "\u3053\u306E\u30A2\u30D7\u30EA\u306E\u4FDD\u5B58\u30C7\u30FC\u30BF(\u98DF\u54C1DB\u30FB\u65E5\u3005\u306E\u8A18\u9332\u30FB\u8A2D\u5B9A\u30FB\u5065\u5EB7\u60C5\u5831\u306A\u3069\u5168\u3066)\u30921\u3064\u306E\u30C7\u30FC\u30BF\u3068\u3057\u3066\u66F8\u304D\u51FA\u305B\u307E\u3059\u3002\u5225\u306E\u30C1\u30E3\u30C3\u30C8\u306B\u3053\u306E\u98DF\u4E8B\u7BA1\u7406\u30A2\u30D7\u30EA\u306E\u30D5\u30A1\u30A4\u30EB\u3092\u958B\u3044\u305F\u969B\u3001\u4E0B\u306E\u300C\u8AAD\u307F\u8FBC\u3080\u300D\u6B04\u306B\u3053\u3053\u3067\u30B3\u30D4\u30FC\u3057\u305F\u5185\u5BB9\u3092\u8CBC\u308A\u4ED8\u3051\u308C\u3070\u3001\u540C\u3058\u5185\u5BB9\u3092\u5F15\u304D\u7D99\u3052\u307E\u3059\u3002"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center", marginBottom: 8 } }, /* @__PURE__ */ React.createElement(Btn, { primary: true, onClick: doExport }, backupBusy ? "\u66F8\u304D\u51FA\u3057\u4E2D\u2026" : "\u5168\u30C7\u30FC\u30BF\u3092\u66F8\u304D\u51FA\u3059"), backupText && /* @__PURE__ */ React.createElement(Btn, { small: true, onClick: doCopyBackup }, "\u30B3\u30D4\u30FC")), backupText && /* @__PURE__ */ React.createElement(
    "textarea",
    {
      readOnly: true,
      value: backupText,
      style: { width: "100%", height: 140, fontSize: 13, fontFamily: "monospace", padding: 8, border: `0.5px solid ${C.border}`, borderRadius: 8, marginBottom: 4 }
    }
  ), /* @__PURE__ */ React.createElement("div", { style: { height: 1, background: C.border, margin: "14px 0" } }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, marginBottom: 6 } }, "\u4ED6\u306E\u30C1\u30E3\u30C3\u30C8\u3067\u66F8\u304D\u51FA\u3057\u305F\u30C7\u30FC\u30BF\u3092\u8AAD\u307F\u8FBC\u3080"), /* @__PURE__ */ React.createElement(
    "textarea",
    {
      value: restoreText,
      onChange: (e) => setRestoreText(e.target.value),
      placeholder: "\u3053\u3053\u306B\u300C\u5168\u30C7\u30FC\u30BF\u3092\u66F8\u304D\u51FA\u3059\u300D\u3067\u30B3\u30D4\u30FC\u3057\u305F\u5185\u5BB9\u3092\u8CBC\u308A\u4ED8\u3051",
      style: { width: "100%", height: 120, fontSize: 13, fontFamily: "monospace", padding: 8, border: `0.5px solid ${C.border}`, borderRadius: 8, marginBottom: 8 }
    }
  ), /* @__PURE__ */ React.createElement(Btn, { primary: true, onClick: doRestore }, restoreBusy ? "\u8AAD\u307F\u8FBC\u307F\u4E2D\u2026" : "\u3053\u306E\u5185\u5BB9\u3067\u4E0A\u66F8\u304D\u3059\u308B"), restoreResult && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14.5, color: restoreResult.error ? C.danger : C.text, marginTop: 8 } }, restoreResult.error ? restoreResult.error : `\u8AAD\u307F\u8FBC\u307F\u307E\u3057\u305F(\u8A18\u9332${restoreResult.count}\u65E5\u5206\u3092\u542B\u3080)\u3002`), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: C.textMuted, marginTop: 6 } }, "\u3053\u306E\u64CD\u4F5C\u306F\u4ECA\u958B\u3044\u3066\u3044\u308B\u30A2\u30D7\u30EA\u306E\u5185\u5BB9\u3092\u5168\u3066\u4E0A\u66F8\u304D\u3057\u307E\u3059\u3002")), /* @__PURE__ */ React.createElement("div", { style: { background: C.surface, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "1rem 1.1rem" } }, /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, marginBottom: 8 } }, "\u904E\u53BB\u306E\u8A18\u9332\u3092\u307E\u3068\u3081\u3066\u53D6\u308A\u8FBC\u3080"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14.5, color: C.textMuted, lineHeight: 1.6 } }, "Notion\u306A\u3069\u306E\u904E\u53BB\u306E\u98DF\u4E8B\u8A18\u9332\u3092\u5909\u63DB\u3057\u305FJSON\u30C7\u30FC\u30BF\u3001\u307E\u305F\u306F", /* @__PURE__ */ React.createElement("b", null, "\u30C8\u30EC\u30FC\u30CB\u30F3\u30B0\u30BF\u30A4\u30DE\u30FC\u30A2\u30D7\u30EA\u306E\u30DE\u30FC\u30AF\u30C0\u30A6\u30F3\u51FA\u529B(\u4F53\u91CD\u30FB\u5B9F\u65BD\u3057\u305F\u30C8\u30EC\u30FC\u30CB\u30F3\u30B0\u5185\u5BB9)"), "\u3092\u3001\u3053\u3053\u306B\u8CBC\u308A\u4ED8\u3051\u3066\u300C\u53D6\u308A\u8FBC\u3080\u300D\u3092\u62BC\u3059\u3068\u3001\u65E5\u4ED8\u3054\u3068\u306E\u8A18\u9332\u3068\u3057\u3066\u4E00\u62EC\u3067\u4FDD\u5B58\u3055\u308C\u307E\u3059\u3002\u3069\u3061\u3089\u306E\u5F62\u5F0F\u304B\u306F\u81EA\u52D5\u3067\u5224\u5B9A\u3057\u307E\u3059\u3002\u5909\u63DB\u304C\u5FC5\u8981\u306A\u5834\u5408\u306F\u3001\u5143\u306E\u8A18\u9332(Notion\u306E\u30A8\u30AF\u30B9\u30DD\u30FC\u30C8\u7B49)\u3092Claude\u306B\u6E21\u3057\u3066\u3082\u3089\u3048\u308C\u3070\u3001\u3053\u306E\u5F62\u5F0F\u306B\u5909\u63DB\u3057\u307E\u3059\u3002\u6307\u5B9A\u3057\u305F\u9805\u76EE(\u4F53\u91CD\u30FB\u30C8\u30EC\u30FC\u30CB\u30F3\u30B0\u5185\u5BB9\u306A\u3069)\u3060\u3051\u304C\u66F4\u65B0\u3055\u308C\u3001\u305D\u306E\u65E5\u306B\u65E2\u306B\u3042\u308B\u4ED6\u306E\u8A18\u9332(\u98DF\u4E8B\u5185\u5BB9\u306A\u3069)\u306F\u4FDD\u6301\u3055\u308C\u307E\u3059\u3002")), /* @__PURE__ */ React.createElement(
    "textarea",
    {
      value: text,
      onChange: (e) => setText(e.target.value),
      placeholder: 'JSON\u4F8B: [{"date":"2026-09-01","weight":76.5,"refeed":false,"slots":[...]}]\n\u307E\u305F\u306F\u30C8\u30EC\u30FC\u30CB\u30F3\u30B0\u30BF\u30A4\u30DE\u30FC\u30A2\u30D7\u30EA\u306E\u30DE\u30FC\u30AF\u30C0\u30A6\u30F3\u51FA\u529B\u3092\u305D\u306E\u307E\u307E\u8CBC\u308A\u4ED8\u3051',
      style: { width: "100%", height: 220, fontSize: 14, fontFamily: "monospace", padding: 8, border: `0.5px solid ${C.border}`, borderRadius: 8 }
    }
  ), /* @__PURE__ */ React.createElement(Btn, { primary: true, onClick: run }, busy ? "\u53D6\u308A\u8FBC\u307F\u4E2D\u2026" : "\u53D6\u308A\u8FBC\u3080"), result && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: result.error ? C.danger : C.text } }, result.error ? result.error : `${result.ok}\u4EF6\u3092\u53D6\u308A\u8FBC\u307F\u307E\u3057\u305F${result.fail ? `(\u5931\u6557${result.fail}\u4EF6)` : ""}\u3002\u65E5\u4ED8\u3092\u79FB\u52D5\u3059\u308B\u3068\u53CD\u6620\u3055\u308C\u307E\u3059\u3002`));
}
...
function CalendarTab({ target, todayIso, foods, categoryOrder, onOpenInHome, onViewSummary }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { background: C.surface, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "1rem 1.1rem" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", marginBottom: 10, gap: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement(IconBtn, { label: "\u524D\u306E\u6708", onClick: () => changeMonth(-1) }, "\u2190"), /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 600, fontSize: 17 } }, viewYear, "\u5E74", viewMonth + 1, "\u6708"), /* @__PURE__ */ React.createElement(IconBtn, { label: "\u6B21\u306E\u6708", onClick: () => changeMonth(1) }, "\u2192"), /* @__PURE__ */ React.createElement(Btn, { small: true, onClick: goToday }, "\u672C\u65E5")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement(Btn, { small: true, onClick: () => setListOpen(true) }, "\u6708\u5225\u98DF\u54C1\u4E00\u89A7"), /* @__PURE__ */ React.createElement(Btn, { small: true, onClick: () => onViewSummary(`${monthStr}-01`) }, "\u30B5\u30DE\u30EA\u30FC\u3092\u898B\u308B"), /* @__PURE__ */ React.createElement("label", { style: { display: "flex", alignItems: "center", gap: 6, fontSize: 14.5, color: C.textMuted, cursor: "pointer" } }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: refeedOnly, onChange: (e) => setRefeedOnly(e.target.checked) }), "\u30EA\u30D5\u30A3\u30FC\u30C9\u30C7\u30A4\u306E\u307F\u8868\u793A"))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(7, minmax(0,1fr))", gap: 4 } }, ["\u65E5", "\u6708", "\u706B", "\u6C34", "\u6728", "\u91D1", "\u571F"].map((w) => /* @__PURE__ */ React.createElement("div", { key: w, style: { textAlign: "center", fontSize: 13, color: C.textMuted, padding: "2px 0" } }, w)), cells.map((d, i) => {
    var _a;
    ...
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        style: {
          ...
          cursor: "pointer",
          fontSize: 14.5,
          color: hasUnconfirmed ? C.warnText : C.text
        }
      },
  ...
  })), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12.5, color: C.textMuted, marginTop: 8 } }, "\u25CF\u7DD1=\u8A18\u9332\u3042\u308A(\u76EE\u6A19\u5185) \u25CF\u8D64=\u76EE\u6A19\u8D85\u904E \u25CF\u30AA\u30EC\u30F3\u30B8=\u30EA\u30D5\u30A3\u30FC\u30C9\u30C7\u30A4 \u300C!\u300D=\u672A\u78BA\u5B9A\u306E\u98DF\u54C1\u3042\u308A")), listOpen && /* @__PURE__ */ React.createElement(MonthListModal, { monthStr, monthLogs, foods, categoryOrder, onClose: () => setListOpen(false), onSelectDate: (iso) => {
    setSelectedIso(iso);
    setListOpen(false);
    ...
    "textarea",
    {
      ...
      style: { width: "100%", height: 90, fontSize: 14.5, padding: 8, border: `0.5px solid ${C.border}`, borderRadius: 8, resize: "vertical" }
    }
  ))));
}
...
function SummaryTab({ target, todayIso, requestedPeriod, onCopied }) {
  ...
  const exportMd = () => {
    ...
    onCopied == null ? void 0 : onCopied("Markdown\u3092\u30B3\u30D4\u30FC\u3057\u307E\u3057\u305F");
  };
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" } }, [
    ...
    m.label
  ))), mode === "monthRange" ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: 15 } }, /* @__PURE__ */ React.createElement("input", { type: "month", value: rangeStart, onChange: (e) => setRangeStart(e.target.value), style: { ...inputStyle, padding: "5px 8px", width: 140 } }), /* @__PURE__ */ React.createElement("span", { style: { color: C.textMuted } }, "\u301C"), /* @__PURE__ */ React.createElement("input", { type: "month", value: rangeEnd, onChange: (e) => setRangeEnd(e.target.value), style: { ...inputStyle, padding: "5px 8px", width: 140 } })) : mode === "all" ? /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16, fontWeight: 500 } }, periodLabel) : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement(IconBtn, { label: "\u524D\u306E\u671F\u9593", onClick: () => shiftPeriod(-1) }, "\u2190"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 16, fontWeight: 500 } }, periodLabel), /* @__PURE__ */ React.createElement(IconBtn, { label: "\u6B21\u306E\u671F\u9593", onClick: () => shiftPeriod(1) }, "\u2192"))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(2, minmax(0,1fr))", gap: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { background: C.surface, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "1rem" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14.5, color: C.textMuted, marginBottom: 4 } }, "\u6700\u65B0", latestRecord ? `(${latestRecord.date.slice(5).replace("-", "/")})` : ""), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 24, fontWeight: 500 } }, latestRecord && latestRecord.weight != null ? `${latestRecord.weight}kg` : "-")), /* @__PURE__ */ React.createElement("div", { style: { background: C.surface, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "1rem" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14.5, color: C.textMuted, marginBottom: 4 } }, "\u3053\u306E\u671F\u9593\u306E\u5897\u6E1B"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 24, fontWeight: 500, color: kpis.periodDelta > 0 ? C.danger : kpis.periodDelta < 0 ? C.success : C.text } }, kpis.periodDelta != null ? `${kpis.periodDelta > 0 ? "+" : ""}${kpis.periodDelta}kg` : "-")), /* @__PURE__ */ React.createElement("div", { style: { background: C.surface, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "1rem" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14.5, color: C.textMuted, marginBottom: 4 } }, "\u6700\u5927\u5024"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 24, fontWeight: 500 } }, kpis.maxWeight != null ? `${kpis.maxWeight}kg` : "-")), /* @__PURE__ */ React.createElement("div", { style: { background: C.surface, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "1rem" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14.5, color: C.textMuted, marginBottom: 4 } }, "\u6700\u5C0F\u5024"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 24, fontWeight: 500 } }, kpis.minWeight != null ? `${kpis.minWeight}kg` : "-"))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: C.textMuted, marginBottom: 8 } }, "\u4F53\u91CD\u306E\u63A8\u79FB"), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", width: "100%", height: 160 } }, /* @__PURE__ */ React.createElement("canvas", { ref: weightRef }))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 16, marginBottom: 8, fontSize: 14, color: C.textMuted } }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 9, height: 9, borderRadius: 2, background: NUTRIENT_LAYER_COLORS[0], marginRight: 4 } }), "\u30BF\u30F3\u30D1\u30AF\u8CEA\u7531\u6765"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 9, height: 9, borderRadius: 2, background: NUTRIENT_LAYER_COLORS[1], marginRight: 4 } }), "\u8102\u8CEA\u7531\u6765"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-block", width: 9, height: 9, borderRadius: 2, background: NUTRIENT_LAYER_COLORS[2], marginRight: 4 } }), "\u70AD\u6C34\u5316\u7269\u7531\u6765")), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: C.textMuted, marginBottom: 8 } }, "\u7DCF\u6442\u53D6\u30AB\u30ED\u30EA\u30FC\u306E\u5185\u8A33"), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", width: "100%", height: 220 } }, /* @__PURE__ */ React.createElement("canvas", { ref: compRef }))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, marginBottom: 8 } }, Object.entries(nutrientConfigs).map(([k, cfg]) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: k,
      onClick: () => setSubKey(k),
    ...
    cfg.label
  ))), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", width: "100%", height: 140 } }, /* @__PURE__ */ React.createElement("canvas", { ref: subRef })), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13.5, color: C.textMuted, marginTop: 4 } }, fmtRange(nutrientConfigs[subKey].range, nutrientConfigs[subKey].unit), "(\u7070\u8272\u70B9\u7DDA=\u76EE\u6A19\u3001\u8D64\u8272\u70B9\u7DDA=\u4E0A\u9650)")), /* @__PURE__ */ React.createElement(Btn, { onClick: exportMd }, "\u3053\u306E\u671F\u9593\u3092Markdown\u3067\u30B3\u30D4\u30FC"));
}
...
const emptyHealthForm = () => ({ title: "", type: "note", content: "", tags: [] });
function HealthInfoCard({ item, onEdit, onDelete, mediaTags }) {
  const [noteOpen, setNoteOpen] = useState(false);
  return /* @__PURE__ */ React.createElement("div", { style: { background: C.surface, border: `0.5px solid ${C.border}`, borderRadius: 12, padding: "1rem 1.1rem", display: "flex", flexDirection: "column", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 600, fontSize: 16 } }, item.title || "(\u7121\u984C)"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6 } }, /* @__PURE__ */ React.createElement("button", { onClick: onEdit, style: { border: "none", background: "none", color: C.textMuted, cursor: "pointer", fontSize: 14 } }, "\u7DE8\u96C6"), /* @__PURE__ */ React.createElement("button", { onClick: onDelete, style: { border: "none", background: "none", color: C.danger, cursor: "pointer", fontSize: 14 } }, "\u524A\u9664"))), (item.tags || []).length > 0 && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 4 } }, item.tags.map((t) => /* @__PURE__ */ React.createElement(TagPill, { key: t, tag: t, order: mediaTags, small: true }))), item.type === "note" && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { onClick: () => setNoteOpen((v) => !v), style: { display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "pointer" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, color: C.textMuted } }, "\u672C\u6587"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 13, color: C.textMuted } }, noteOpen ? "\u25B2 \u9589\u3058\u308B" : "\u25BC \u958B\u304F")), noteOpen && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, whiteSpace: "pre-wrap", color: C.text, marginTop: 8 } }, item.content)), item.type === "webpage" && /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement("a", { href: item.content, target: "_blank", rel: "noreferrer", style: { fontSize: 14.5, color: C.accent } }, item.content), /* @__PURE__ */ React.createElement("iframe", { src: item.content, title: item.title, style: { width: "100%", height: 360, border: `0.5px solid ${C.border}`, borderRadius: 8, background: "#fff" } }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: C.textMuted } }, "\u30B5\u30A4\u30C8\u306B\u3088\u3063\u3066\u306F\u57CB\u3081\u8FBC\u307F\u8868\u793A\u3067\u304D\u306A\u3044\u5834\u5408\u304C\u3042\u308A\u307E\u3059\u3002\u305D\u306E\u969B\u306F\u4E0A\u306E\u30EA\u30F3\u30AF\u304B\u3089\u958B\u3044\u3066\u304F\u3060\u3055\u3044\u3002")), item.type === "youtube" && (youtubeEmbedUrl(item.content) ? /* @__PURE__ */ React.createElement("div", { style: { position: "relative", paddingTop: "56.25%" } }, /* @__PURE__ */ React.createElement(
    "iframe",
    {
...
function HealthInfoTab({ items, onAdd, onUpdate, onDelete, onMove, mediaTags, onAddTag, onRenameTag, onDeleteTag, onMoveTag }) {
  ...
  const filteredItems = items.filter((it) => {
    ...
    const s = q.trim().toLowerCase();
    return it.title.toLowerCase().includes(s) || (it.content || "").toLowerCase().includes(s) || (it.tags || []).some((t) => t.toLowerCase().includes(s));
  });
  const typeTabs = [
    { k: "note", label: "\u30E1\u30E2" },
    { k: "webpage", label: "Web" },
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6 } }, typeTabs.map((t) => /* @__PURE__ */ React.createElement(
    ...
    return /* @__PURE__ */ React.createElement("div", { key: t, style: { display: "flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement(
      ...
      "input",
      {
        ...
        onChange: (e) => setRenameDrafts({ ...renameDrafts, [t]: e.target.value }),
      ...
      Btn,
      {
        ...
        onClick: () => {
          var _a2;
          const next = ((_a2 = renameDrafts[t]) != null ? _a2 : t).trim();
          if (next && next !== t) onRenameTag(t, next);
        }
      },
      "\u540D\u524D\u3092\u5909\u66F4"
    ), /* @__PURE__ */ React.createElement(
      ...
      {
        onClick: () => {
          if (window.confirm(`\u30BF\u30B0\u300C${t}\u300D\u3092\u524A\u9664\u3057\u307E\u3059\u304B?\u3053\u306E\u30BF\u30B0\u304C\u4ED8\u3044\u3066\u3044\u308B\u9805\u76EE\u304B\u3089\u3082\u5916\u308C\u307E\u3059\u3002`)) onDeleteTag(t);
        },
        style: { border: "none", background: "none", color: C.danger, cursor: "pointer", fontSize: 14 }
      },
      "\u524A\u9664"
    ));
  }))), /* @__PURE__ */ React.createElement("input", { placeholder: "\u30BF\u30A4\u30C8\u30EB\u30FB\u672C\u6587\u30FB\u30BF\u30B0\u3067\u691C\u7D22", value: q, onChange: (e) => setQ(e.target.value), style: { ...inputStyle, width: "100%" } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 12 } }, filteredItems.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: C.textMuted } }, "\u8A72\u5F53\u3059\u308B\u9805\u76EE\u304C\u3042\u308A\u307E\u305B\u3093\u3002") : filteredItems.map((item, i) => /* @__PURE__ */ React.createElement("div", { key: item.id, style: { display: "flex", gap: 8, alignItems: "flex-start" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 2, paddingTop: 4 } }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => onMove(item.id, -1),
      disabled: i === 0,
      style: { border: "none", background: "none", cursor: i === 0 ? "default" : "pointer", opacity: i === 0 ? 0.3 : 1, fontSize: 14, color: C.textMuted }
    },
    "\u25B2"
  ), /* @__PURE__ */ React.createElement(
    "button",
...
function App() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setHealthInfo(hi);
      let mt = await loadJSON("mediaTags", null);
      if (!mt) {
        mt = [];
        await saveJSON("mediaTags", mt);
      }
      setMediaTags(mt);
    })();
  }, []);
  ...
  if (!foods || !target || !categoryOrder || !healthInfo || !mediaTags || !day || !withTotals) {
...
(\u307E\u3068\u3081\u308B\u3068\u3001\u5F8C\u3067\u6804\u990A\u7D20\u3092\u78BA\u5B9A\u3057\u305F\u6642\u306B\u3053\u306E\u8A18\u9332\u306B\u3082\u307E\u3068\u3081\u3066\u53CD\u6620\u3055\u308C\u307E\u3059\u3002\u5225\u7269\u3067\u3042\u308C\u3070\u300C\u30AD\u30E3\u30F3\u30BB\u30EB\u300D\u3092\u62BC\u3057\u3001\u540D\u524D\u306E\u672B\u5C3E\u306B\u6570\u5B57\u3092\u4ED8\u3051\u308B\u30FB\u304A\u5E97\u306E\u540D\u524D\u3092\u52A0\u3048\u308B\u306A\u3069\u3057\u3066\u533A\u5225\u3057\u3066\u304B\u3089\u767B\u9332\u3057\u76F4\u3057\u3066\u304F\u3060\u3055\u3044\u3002)`
  ...
  const exportAllData = async () => {
    ...
    return JSON.stringify({ foods, settings: target, categoryOrder, healthInfo, mediaTags, logs });
  };
  const importAllData = async (jsonText) => {
    ...
    if (Array.isArray(data.mediaTags)) {
      setMediaTags(data.mediaTags);
      await saveJSON("mediaTags", data.mediaTags);
    }
    let count = 0;
  ...
  const deleteFood = async (name) => {
    const updated = foods.filter((f) => f.n !== name);
    setFoods(updated);
    await saveJSON("foods", updated);
  };
  ...
  const moveHealthInfo = async (id, dir) => {
    const item = healthInfo.find((h) => h.id === id);
    if (!item) return;
    const sameType = healthInfo.map((h, idx) => ({ h, idx })).filter((x) => x.h.type === item.type);
    const pos = sameType.findIndex((x) => x.h.id === id);
    const swapPos = pos + dir;
    if (swapPos < 0 || swapPos >= sameType.length) return;
    const idxA = sameType[pos].idx;
    const idxB = sameType[swapPos].idx;
    const updated = [...healthInfo];
    [updated[idxA], updated[idxB]] = [updated[idxB], updated[idxA]];
    setHealthInfo(updated);
    await saveJSON("healthInfo", updated);
  };
  const addMediaTag = async (name) => {
    if (mediaTags.includes(name)) return;
    const updated = [...mediaTags, name];
    setMediaTags(updated);
    await saveJSON("mediaTags", updated);
  };
  const renameMediaTag = async (oldName, newName) => {
    const updatedTags = mediaTags.map((t) => t === oldName ? newName : t);
    setMediaTags(updatedTags);
    await saveJSON("mediaTags", updatedTags);
    const updatedItems = healthInfo.map((h) => ({ ...h, tags: (h.tags || []).map((t) => t === oldName ? newName : t) }));
    setHealthInfo(updatedItems);
    await saveJSON("healthInfo", updatedItems);
  };
  const deleteMediaTag = async (name) => {
    const updatedTags = mediaTags.filter((t) => t !== name);
    setMediaTags(updatedTags);
    await saveJSON("mediaTags", updatedTags);
    const updatedItems = healthInfo.map((h) => ({ ...h, tags: (h.tags || []).filter((t) => t !== name) }));
    setHealthInfo(updatedItems);
    await saveJSON("healthInfo", updatedItems);
  };
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "'Zen Kaku Gothic New','Noto Sans JP',sans-serif", color: C.text, background: C.bg, padding: 18, borderRadius: 14 } }, /* @__PURE__ */ React.createElement("style", null, `input, select, button, textarea { font-family: inherit; }
  ...
  ), tab === "summary" && /* @__PURE__ */ React.createElement(SummaryTab, { target, todayIso: fmtISO(/* @__PURE__ */ new Date()), requestedPeriod: summaryRequest, onCopied: showToast }), tab === "health" && /* @__PURE__ */ React.createElement(
    HealthInfoTab,
    {
      items: healthInfo,
      onAdd: addHealthInfo,
      onUpdate: updateHealthInfo,
      onDelete: deleteHealthInfo,
      onMove: moveHealthInfo,
      mediaTags,
  ...
  ), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 15, color: C.textMuted } }, "kg"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14.5, color: C.textMuted } }, "\u524D\u65E5", " ", weights.prev != null ? /* @__PURE__ */ React.createElement(React.Fragment, null, weights.prev, "kg", " ", day.weight != null && /* @__PURE__ */ React.createElement("span", { style: { color: day.weight - weights.prev > 0 ? C.danger : C.success } }, "(", day.weight - weights.prev >= 0 ? "+" : "", (day.weight - weights.prev).toFixed(1), ")")) : "\u8A18\u9332\u306A\u3057", " ", "\u524D\u3005\u65E5", " ", weights.prev2 != null ? /* @__PURE__ */ React.createElement(React.Fragment, null, weights.prev2, "kg", " ", weights.prev != null && /* @__PURE__ */ React.createElement("span", { style: { color: weights.prev - weights.prev2 > 0 ? C.danger : C.success } }, "(", weights.prev - weights.prev2 >= 0 ? "+" : "", (weights.prev - weights.prev2).toFixed(1), ")")) : "\u8A18\u9332\u306A\u3057")), /* @__PURE__ */ React.createElement(NutrientBars, { totals: null, target, slots: withTotals })), /* @__PURE__ */ React.createElement(Btn, { wide: true, onClick: addSlot }, "+ \u65B0\u3057\u3044\u98DF\u4E8B\u67A0\u3092\u8FFD\u52A0(", nextSlotId(day.slots), ")"), copyMsg && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: C.accent } }, copyMsg), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 12 } }, orderedSlots.map((s) => /* @__PURE__ */ React.createElement(
    SlotCard,
    {
      key: s.id,
      slot: s,
    ...
    /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 600, fontSize: 15 } }, "\u30E1\u30E2", day.aiNote ? "" : "(\u672A\u8A18\u5165)"),
    /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, color: C.textMuted } }, noteOpen ? "\u25B2 \u9589\u3058\u308B" : "\u25BC \u958B\u304F")
    ...
    "textarea",
    {
      ...
      style: { width: "100%", height: 160, fontSize: 14.5, padding: 8, border: `0.5px solid ${C.border}`, borderRadius: 8, resize: "vertical", marginTop: 10 }
    }
  )), /* @__PURE__ */ React.createElement(
    "div",
    {
    ...
    "\u30B3\u30D4\u30FC"
  ), /* @__PURE__ */ React.createElement(Btn, { small: true, onClick: () => setShowMd(false) }, "\u9589\u3058\u308B"))), /* @__PURE__ */ React.createElement("textarea", { readOnly: true, value: md, style: { width: "100%", height: 220, fontSize: 14, fontFamily: "monospace", padding: 8, border: `0.5px solid ${C.border}`, borderRadius: 8 } }))), /* @__PURE__ */ React.createElement(Toast, { message: toast }));
}
